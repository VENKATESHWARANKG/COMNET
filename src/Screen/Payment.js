...
export default class Payment extends Component{
    constructor() {
        ...
        this.state = {
          ...
          BankBranch:"",
          IFSC:"",
          tableHeader: ["Payment Date", "Payee Name", "Payer Name", "Reference Number", "Paid Amount","Payment Status","Remarks"]
        }
      }
      componentDidMount() {
              ...
              <div className="col-12">
                <div className="row content-window-title">
                  <div className="col-xl-12 content-window-title-text text-center">
                    <b><p style={{ paddingTop: "1em",fontSize:20 }}>Create Payment</p></b>
                  </div>
                </div>
                        ...
                        <form className='col-lg-12' id='Create Party' onSubmit={this.onSubmit}>
                          <div className="row  mt-3" >
                            <div className="col-lg-4">
                              <b><label>Ledger Name <span className="mandatory">*</span></label></b>
                            ...
                            <div className="col-lg-3">
                              <b><label>Reference Number <span className="mandatory">*</span></label> </b>
                              <input className=" form-control form-control-sm" required />
                            </div>
    
                            <div className="col-lg-3">
                              <button className="btn btn-success btn-sm " style={{ marginTop: '2rem' }} id="Report" type="submit" >Find Payment</button>
                              <button className="btn btn-success btn-sm mx-2" style={{ marginTop: '2rem' }} data-toggle="modal" data-target="#exampleModalCenter" >Add Payment</button>
                            </div>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title modal-" id="exampleModalLongTitle">Create Payment</h5>
                    ...
                    <div>
                      <form className='col-lg-12' id='Create Party' onSubmit={this.onSubmit}>
                        <div className="row  mt-6" >
                          ...
                          <button type="submit" class="btn btn-success float-right mx-2">Add Payment</button>
